    ...
    <>
      ...
      <div style={{ padding: '0 16px', marginBottom: 12 }}>
        <div style={{ borderRadius: 20, overflow: 'hidden', position: 'relative', boxShadow: '0 12px 30px rgba(0,0,0,0.12)' }}>
          <div style={{ width: '100%', height: 200, background: SPOT_COLORS[0], position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
        {rest.map((s, i) => (
          <div key={s.place_id} style={{ display: 'flex', gap: 12, padding: 10, borderRadius: 14, background: 'var(--cream-2)', border: '1px solid var(--line)' }}>
            <div style={{ width: 64, height: 64, borderRadius: 12, background: SPOT_COLORS[(i + 1) % SPOT_COLORS.length], position: 'relative', overflow: 'hidden', flexShrink: 0 }}>
